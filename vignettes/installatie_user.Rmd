...
1. Start RStudio
1. Ga naar het tabblad _Packages_.
1. Klik op _install_.
1. Selecteer bij _Install from_ `Package archive file`
1. Er opent nu een file browser. Ga naar `P:/Algemeen/Algemene info/BMK/R` en selecteer `INBOmd_x.y.tar.gz`
1. Klik op _Install_ en waacht tot het package geïnstalleerd is.
...
1. Indien  `C:\R\library\INBOmd\local_tex` niet bovenaan de lijst van _Roots_ staat, selecteer je `C:\R\library\INBOmd\local_tex` en klik op _Up_ tot dat het bovenaan de lijst staat.
