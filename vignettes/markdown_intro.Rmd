...
- optioneel voor cover
    ...
    cover_offset
      ~ schuift de coverfoto naar boven. Zowel afstand als eenheid opgeven. Negatieve waarde (-10mm) = naar benenden schuiven. Default = 0mm
    cover_text
...
# meer bepaald \begin{block}, \begin{exampleblock} en \begin{alertblock}
render(
  "markdown_intro.Rmd", 
