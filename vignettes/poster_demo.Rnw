...
\begin{textblock}{\Sexpr{INBOmd::kolom_breedte(2)}}(\Sexpr{INBOmd::kolom_start(2, 1)}, 715)
...
\begin{textblock}{\Sexpr{INBOmd::kolom_breedte(2)}}(\Sexpr{INBOmd::kolom_start(2, 2)}, 715)
