...
$if(reviewer)$
\reviewer{
$for(reviewer)$$if(reviewer.name)$$if(reviewer.orcid)$\href{https://orcid.org/$reviewer.orcid$}{$endif$$if(reviewer.firstname)$$reviewer.firstname$ $endif$$reviewer.name$$if(reviewer.orcid)$\includegraphics[height=\fontsizebase]{orcid.eps}}$endif$$else$$reviewer$$endif$$sep$, $endfor$
}
$endif$
$if(reportnr)$
\reportnr{$reportnr$}
...
\colofonauthor{
$for(author)$
$if(author.name)$$if(author.orcid)$\href{https://orcid.org/$author.orcid$}{$endif$$if(author.firstname)$$author.firstname$ $endif$$author.name$$if(author.orcid)$\includegraphics[height=\fontsizebase]{orcid.eps}}$endif$$else$$author$$endif$$sep$, $endfor$
}
