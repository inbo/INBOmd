...
flandersfont
  ~ Use Flanders Art if TRUE (set as FALSE in this template). Requires that the Flanders Art font is installed. Note: this font is a necessary part of the Flemish corporate style.
  ~ Use Calibri if FALSE (= default if flandersfont parameter is not provided)
