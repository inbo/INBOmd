...
This is the _content_ of the **HTML block**. We can refer to section \@ref(S:figures).
...
This is the _content_ of the **HTML example block**. We can refer to section \@ref(S:figures).
...
This is the _content_ of the **HTML alert block**. We can refer to section \@ref(S:figures).
...
This is the _content_ of the **PDF block**. We can refer to section \@ref(S:figures).
...
This is the _content_ of the **PDF example block**. We can refer to section \@ref(S:figures).
...
This is the _content_ of the **PDF alert block**. We can refer to section \@ref(S:figures).
