...
To do similar things in HTML-based output formats, using CSS, see https://bookdown.org/yihui/bookdown/custom-blocks.html.

```{block2, type = "block", latex.options = "{Title of a block}"}
This is a block.
```

```{block2, type = "exampleblock", latex.options = "{Title of an example block}"}
This is an example block.

You **can** add _Markdown_ formatting.
```

```{block2, type = "alertblock", latex.options = "{Title of an alert block}"}
