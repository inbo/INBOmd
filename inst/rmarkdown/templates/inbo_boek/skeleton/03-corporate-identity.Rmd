...
Page orientation is portrait by default. You can begin landscape-oriented pages at a given position in your document by inserting the command `\begin{landscape}`. To improve readability, we recommend placing it on a separate line. Further in the text, you insert `\end{landscape}`, to mark the position where landscape orientation ends. Again, it is recommended to place it on a separate line.
