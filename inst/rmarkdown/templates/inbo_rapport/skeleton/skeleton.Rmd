...
_External_ figures can be inserted from within an R code chunk, using the `include_graphics()` function\autorefp{fig:labo}. The same chunk options apply as before, including `fig.cap`.

```{r externalfig, fig.cap = "\\label{fig:labo}Including an external figure with a caption is easy.", out.width = "70%", fig.align = "center"}
